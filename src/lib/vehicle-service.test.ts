...
describe('VehicleService', () => {
  ...
  describe('createVehicle', () => {
    describe('sedan creation', () => {
      ...
      it('registers sedan successfully regardless of mileage', () => {
        const input = {
          type: 'sedan' as const,
        ...
        expect(result.ok).toBe(true);
        if (result.ok) {
          expect(result.value.registration.status).toBe('registered');
          if (result.value.registration.status === 'registered') {
            expect(result.value.registration.registrationId).toMatch(/^SEDAN-/);
          }
        }
      });
    ...
    describe('motorcycle creation', () => {
      ...
      it('registers motorcycle successfully regardless of mileage', () => {
        const input = {
          type: 'motorcycle' as const,
