...
| File | Purpose |
|------|---------|
| `TECHNICAL_DESIGN.md` | Complete architecture, domain model, state management, testing strategy |
| `IMPLEMENTATION_GUIDE.md` | Full code patterns, Zod schemas, service implementations, test examples |
