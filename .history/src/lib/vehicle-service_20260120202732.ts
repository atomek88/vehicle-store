    ...
    createVehicle(input: VehicleFormInput, existingVehicles: Vehicle[]): Result<Vehicle, DomainError> {
      ...
      switch (input.type) {
        ...
        case 'coupe': {
          ...
          const doors = input.doors ?? getDefaultDoors('coupe');
        ...
        case 'motorcycle': {
          const wheels = input.wheels ?? getDefaultWheels('motorcycle');
    ...
    updateVehicle(id: string, input: VehicleFormInput, existingVehicles: Vehicle[]): Result<Vehicle, DomainError> {
      ...
      switch (input.type) {
        ...
        case 'coupe': {
          ...
          const doors = input.doors ?? (existingVehicle as Coupe).doors;
        ...
        case 'motorcycle': {
          const wheels = input.wheels ?? (existingVehicle as Motorcycle).wheels;
