...
export default function VehiclesPage() {
  ...
  const { state, filteredVehicles, setFilters, resetFilters, setSorting, deleteVehicle } = useVehicles();
    ...
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 flex items-center justify-between">
          ...
          <Button onClick={() => setIsCreateModalOpen(true)}>Create Vehicle</Button>
        </div>
        ...
        {isCreateModalOpen && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-2xl rounded-lg bg-white p-6 shadow-xl">
              ...
              <VehicleForm
                onSubmit={async (data) => {
                  const result = await useVehicles().createVehicle(data);
                  if (result.ok) {
