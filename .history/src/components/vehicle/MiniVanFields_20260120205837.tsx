  ...
  return (
    <>
      <Select
        ...
        // use any here : react-hook-form's FieldErrors type not being able to narrow based on the discriminated union.
      ...
      <div className="space-y-2">
        ...
        {(errors as any).doorConfig && (
          <p className="text-sm text-red-600">{(errors as any).doorConfig.message}</p>
        )}
      </div>
