              ...
              <tr key={vehicle.id} className="hover:bg-gray-50">
                ...
                <td className="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                  <div className="flex justify-end gap-2">
                    <Button size="sm" variant="ghost" onClick={() => onView(vehicle.id)}>
                      View
                    </Button>
                    <Button size="sm" variant="secondary" onClick={() => onEdit(vehicle.id)}>
                      Edit
                    </Button>
                    <Button size="sm" variant="danger" onClick={() => onDelete(vehicle.id)}>
                      Delete
                    </Button>
                  </div>
                </td>
