...
export function FiltersBar({ filters, onFiltersChange, onReset, onSeedData }: FiltersBarProps) {
  ...
  return (
    <div>
      ...
      <div className="mt-6 flex justify-between border-t border-gray-300 pt-6">
        <Button variant="secondary" size="sm" onClick={onSeedData} className="shadow-sm">
          Seed Data
        </Button>
